...
export class MyUIRouterConfig {
  constructor(private injector: Injector, private nameListService: NameListService) {}
  ...
  configure(uiRouter: UIRouter) {
    ...
    uiRouter.urlRouterProvider.otherwise(() => uiRouter.stateService.go('app.home', null, null));
    ...
    rootState.resolve['nameListService'] = () => this.nameListService;
  }
}
